...
var styledUl = Css.style(/* :: */[
      Css.padding(Css.zero),
      /* [] */0
    ]);

var userContainer = Css.style(/* :: */[
      Css.padding(Css.rem(2.0)),
      /* [] */0
    ]);
...
var ppx_printed_query = "query findAll($appId: ID!)  {\nusers(appId: $appId, where: {})  {\nid  \nname  \ncreatedAt  \nroles  {\nid  \nname  \ndescription  \npermissions  {\nname  \ndescription  \n}\n\n}\n\n}\n\n}\n";
                                ...
                                if (match !== undefined) {
                                  ...
                                  if (match$1 !== undefined) {
                                    ...
                                    if (match$2 !== undefined) {
                                      ...
                                      field_id = Js_exn.raiseError("graphql_ppx: Field id on type Role is missing");
                                    }
                                    ...
                                    if (match$7 !== undefined) {
                                      ...
                                      if (match$8 !== undefined) {
                                        ...
                                        field_description = match$9 !== undefined ? match$9 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$4));
                                      }
                                    } else {
                                      field_description = undefined;
                                    }
                                    var match$10 = Js_dict.get(value$1, "permissions");
                                    ...
                                    if (match$10 !== undefined) {
                                      ...
                                      if (match$11 !== undefined) {
                                        ...
                                        field_permissions = match$12 !== undefined ? match$12.map((function (value) {
                                                  var match = Js_json.decodeNull(value);
                                                  if (match !== undefined) {
                                                    return undefined;
                                                  } else {
                                                    ...
                                                    if (match$1 !== undefined) {
                                                      ...
                                                      if (match$2 !== undefined) {
                                                        ...
                                                        if (match$3 !== undefined) {
                                                          ...
                                                          field_name = match$4 !== undefined ? match$4 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$2));
                                                        }
                                                      } else {
                                                        field_name = undefined;
                                                      }
                                                      ...
                                                      if (match$5 !== undefined) {
                                                        ...
                                                        if (match$6 !== undefined) {
                                                          ...
                                                          field_description = match$7 !== undefined ? match$7 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$3));
                                                        }
                                                      } else {
                                                        field_description = undefined;
                                                      }
                                                      ...
                                                      tmp = Js_exn.raiseError("graphql_ppx: Expected object of type Permission, got " + JSON.stringify(value));
                                                    }
                                                    return tmp;
                                                  }
                                    ...
                                    tmp = Js_exn.raiseError("graphql_ppx: Expected object of type Role, got " + JSON.stringify(value));
                                  }
                                  return tmp;
                                }
                              })) : Js_exn.raiseError("graphql_ppx: Expected array, got " + JSON.stringify(value$5));
          ...
          /* render */(function (_self) {
              ...
              return React.createElement("div", {
                          className: cls
                                    ...
                                    make$1("deals", "Prasanna", "prasanna.gnanaraj@alphasights.com", /* () */0);
                                    return React.createElement("div", undefined);
                                  }))), ReasonReact.element(undefined, undefined, Curry.app(ViewQueryComponent[/* make */3], [
                                  ...
                                  (function (param) {
                                      ...
                                      if (typeof result === "number") {
                                        return React.createElement("div", undefined, "Loading users!");
                                      } else if (result.tag) {
                                        return React.createElement("div", {
                                                    className: userContainer
                                                  }, React.createElement("ul", {
                                                        className: styledUl
                                                      }, $$Array.map(displayDetails, result[0].users)));
                                      } else {
